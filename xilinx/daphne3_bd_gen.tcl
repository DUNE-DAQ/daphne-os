...
# also add the new AXI Lite RAM IP before generating the Block Design
...
dune.pds:user:outspy64_axilite:1.0\
...
set TX0_GTH_P [create_bd_port -dir O TX0_GTH_P]
set TX0_GTH_N [create_bd_port -dir O TX0_GTH_N]
set SFP_GTH0_TX_DIS [create_bd_port -dir O SFP_GTH0_TX_DIS]
...
# create instance: AXI_LITE_RAM
set axiRamVlnv dune.pds:user:outspy64_axilite:1.0
set axiram_block_cell_name outspy64_axilite
if {[catch {set outspy64_axilite_0 [create_bd_cell -vlnv $axiRamVlnv -type IP $axiram_block_cell_name]} errmsg]} {
    puts "ERROR: Failed to add block <$axiram_block_cell_name>. Please ensure it is defined and sourced properly before running this script."
    return 1
} elseif { $outspy64_axilite_0 eq ""} {
    puts "ERROR: Block <$axiram_block_cell_name> could not be found after creation attempt. Check if the IP is available."
    return 1
}
...
# # create instance: ila_0, and set its properties
# set ila_0 [create_bd_cell -vlnv xilinx.com:ip:ila:6.2 -type IP ila_0]
# set_property CONFIG.C_MONITOR_TYPE {Native} $ila_0
...
connect_bd_intf_net -intf_net smartconnect_0_M10_AXI [get_bd_intf_pins outspy64_axilite/S_AXI] [get_bd_intf_pins smartconnect_0/M10_AXI]
...
# connect_bd_net -net DAPHNE3_gth0_debut [get_bd_pins DAPHNE3/gth0_debut] [get_bd_pins ila_0/probe0]
...
connect_bd_net -net DAPHNE3_out_buff_trig [get_bd_pins DAPHNE3/out_buff_trig] [get_bd_pins outspy64_axilite/trig]
connect_bd_net -net DAPHNE3_out_buff_clk [get_bd_pins DAPHNE3/out_buff_clk] [get_bd_pins outspy64_axilite/clock]
connect_bd_net -net DAPHNE3_out_buff_data [get_bd_pins DAPHNE3/out_buff_data] [get_bd_pins outspy64_axilite/data_in]
connect_bd_net -net DAPHNE3_VALID_DEBUG [get_bd_pins DAPHNE3/VALID_DEBUG] [get_bd_pins outspy64_axilite/Valid]
connect_bd_net -net DAPHNE3_LAST_DEBUG [get_bd_pins DAPHNE3/LAST_DEBUG] [get_bd_pins outspy64_axilite/last]
...
connect_bd_net -net Net1 [get_bd_pins SYSTEM_RESET/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins outspy64_axilite/S_AXI_ARESETN] [get_bd_pins DAPHNE3/FRONT_END_S_AXI_ARESETN] [get_bd_pins DAPHNE3/SPY_BUF_S_S_AXI_ARESETN] [get_bd_pins DAPHNE3/END_P_S_AXI_ARESETN] [get_bd_pins DAPHNE3/SPI_DAC_S_AXI_ARESETN] [get_bd_pins DAPHNE3/AFE_SPI_S_AXI_ARESETN] [get_bd_pins DAPHNE3/TRIRG_S_AXI_ARESETN] [get_bd_pins DAPHNE3/STUFF_S_AXI_ARESETN]
...
connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins SYSTEM_RESET/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins outspy64_axilite/S_AXI_ACLK] [get_bd_pins DAPHNE3/FRONT_END_S_AXI_ACLK] [get_bd_pins DAPHNE3/SPY_BUF_S_S_AXI_ACLK] [get_bd_pins DAPHNE3/END_P_S_AXI_ACLK] [get_bd_pins DAPHNE3/SPI_DAC_S_AXI_ACLK] [get_bd_pins DAPHNE3/AFE_SPI_S_AXI_ACLK] [get_bd_pins DAPHNE3/TRIRG_S_AXI_ACLK] [get_bd_pins DAPHNE3/STUFF_S_AXI_ACLK]
...
# connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_pins zynq_ultra_ps_e_0/pl_clk2] [get_bd_pins ila_0/clk]
...
assign_bd_address -offset 0x8C000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_3 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/SPI_DAC_S_AXI/reg0] -force
assign_bd_address -offset 0x90000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_4 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/SPY_BUF_S_S_AXI/reg0] -force
assign_bd_address -offset 0x94000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_5 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/STUFF_S_AXI/reg0] -force
assign_bd_address -offset 0x98000000 -range 0x04000000 -with_name SEG_DAPHNE3_reg0_6 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs DAPHNE3/TRIRG_S_AXI/reg0] -force
assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs outspy64_axilite/S_AXI/reg0] -force
...
set_property PFM_NAME {xilinx:k26c:name:0.0} [get_files [current_bd_design].bd]
