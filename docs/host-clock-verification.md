...
| I099/I100 peer offset/time source | **Not yet implemented** | Kernel adjustment offset is deliberately not substituted for a measured NTP peer offset |
...
regression, timesyncd peer/sample reporting, complete runtime/pin/ONL handoff and
new-firmware/full-stream/image qualification remain pending.
