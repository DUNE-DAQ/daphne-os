...
| Host resources / workbook I088 and I101–I104 | Host uptime, CPU load, available memory and root filesystem free/available/read-only values; typed quality and observation times, no inferred operational-health verdict | Source implemented; 25 native/ARM suites, 109 Python tests and native standalone collector probes pass. RPC deployment pending. Probe finds approximately 23 MiB root space available to unprivileged processes; no cleanup/resizing performed. See host-resource-verification.md |
