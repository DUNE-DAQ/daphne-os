...
| Host clock / workbook I086/I087/I090 and I098–I100 | Local clock/derived boot observations, kernel synchronization evidence, actual timesync-service source/sample/offset reporting with explicit freshness and privacy | Source 702155b adds wall/boot/kernel and typed timesync service/history: 31 host/31 actual ARM suites, 185 Python tests per binding and standalone probes pass. Board reports May 2025, unsynchronized and no processed NTP samples; offset/age unavailable. No clock correction or deployment. Candidate live regression/runtime handoff and approved-source/fresh NTP evidence remain pending; see timesync-verification.md |
