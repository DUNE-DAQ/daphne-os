...
| Qualification and handoff | Native/ARM tests, negative/stale/concurrency cases, live zero-BIAS/all-channel regression, both-ABI scope recorded, protocol clients/docs/wiki and ONL bundle | Server fb82e0a native/live ABI 2.0 SC preservation and full regression pass; runtime/native loader, new image pin and ONL handoff remain pending. The prior 4e74f10 runtime/pin/35-file handoff remains unchanged and lacks this fix. New-firmware/full-stream/image qualification and remaining hardware/database evidence are still pending |
