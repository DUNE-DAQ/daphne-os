...
| --- | --- | --- |
| Kernel/OS identification / I091–I093 | Per-field quality/times for running kernel and OS release; keep original base/image labels separate from current rootfs integrity | Candidate 710e336: seven typed observations, 32 host C++ suites, full ARM build and 12 new Python tests pass. Not deployed; clean/native/live/runtime qualification remains pending. I093 is partial; no approved installed-rootfs manifest. See host-software-verification.md |
