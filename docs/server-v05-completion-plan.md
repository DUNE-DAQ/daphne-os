...
| AFE global readback / I283–I288 | Fresh quality/timed POWERSTATE, reset, SPI busy and BiasEnable register observations; SC owns requested energization | Candidate 78504f1: clean 33 host/33 actual ARM suites and 203 Python tests per binding pass. Two read-only DAPHNE-015 collector probes pass with unchanged protected configuration/services. Installed server remains 75972de; candidate RPC/full regression and runtime handoff pending. See afe-global-readback-verification.md |
...
| Qualification and handoff | Native/ARM tests, negative/stale/concurrency cases, live zero-BIAS/all-channel regression, both-ABI scope recorded, protocol clients/docs/wiki and ONL bundle | Server 75972de native/live ABI 2.0 regression, complete runtime/native loader, image pin, 30-file ONL handoff and published wiki pass. Exported OS/clock/build clients and applied-state guard pass from ONL. Prior 702155b handoff is retained and checksum-verified. New-firmware/full-stream/image qualification and remaining hardware/database evidence are still pending |
